	...
	public void testTriggerBindsOnScopeFinderRegistration() throws Exception {
		...
		try (SafeCloseable safeCloseable = CompanyThreadLocal.lock(companyId)) {
			...
			try {
				...
				// Registering a ScopeFinder fires ScopeFinderReconcileTrigger;
				// the reconcile is not invoked directly here
				...
				serviceRegistration = bundleContext.registerService(
					...
					HashMapDictionaryBuilder.<String, Object>put(
						"osgi.jaxrs.name", "Test.ScopeReResolution.Application"
					).build());
