...
export const STORAGE_KEYS = {
	APPLICATION_FORM: 'marketplace-application-form',
	APPLICATION_ID: 'marketplace-application-id',
	BACK_TO_EDIT: 'marketplace-back-to-edit',
	BASIC_STEP_CLICKED: 'basic-step-clicked',
	CONTEXTUAL_MESSAGE: 'marketplace-contextual-message',
	PRODUCT: 'marketplace-product',
	QUOTE_ID: 'marketplace-quote-id',
	SELECTED_PRODUCT: 'marketplace-selected-product',
};
