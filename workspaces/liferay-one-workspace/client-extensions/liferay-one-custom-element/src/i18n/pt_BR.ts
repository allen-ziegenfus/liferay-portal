...
export default {
	...
	'business-event-canceled-successfully':
		'Evento de negócio cancelado com sucesso.',
	...
	'cannot-edit-canceled-or-completed-events':
		'Não é possível editar eventos cancelados ou concluídos.',
	'change': 'Alterar',
	'change-planned-event-date': 'Alterar Data Prevista do Evento',
	...
	'comment': 'Comentário',
	'community-platform': 'Plataforma de comunidade',
	'consumer-products': 'Produtos de consumo',
	'content-management-operations': 'Gestão de conteúdo e operações',
	'create-business-event': 'Criar Evento de Negócio',
	'create-event': 'Criar Evento',
	'create-new-ticket': 'Criar Novo Ticket',
	'crm': 'CRM',
	'current-usage-could-not-be-loaded-the-limits-shown-come-from-your-entitlements':
		'Não foi possível carregar o uso atual. Os limites exibidos vêm dos seus direitos contratados.',
	...
	'data-modeling-process-business-logic':
		'Modelagem de dados, processos e lógica de negócios',
	...
	'education': 'Educação',
	'employee-experience': 'Experiência do funcionário',
	...
	'entering-an-actual-event-date-will-close-this-business-event-no-further-edits-will-be-possible':
		'Inserir uma data real do evento encerrará este evento de negócio. Não será possível fazer mais edições.',
	'enterprise-search': 'Pesquisa empresarial',
	...
	'events': 'Eventos',
	'experience-management': 'Gestão da experiência',
	'extensibility-and-integration': 'Extensibilidade e integração',
	...
	'make-sure-the-ticket-number-is-correct':
		'Certifique-se de que o número do chamado está correto.',
	...
	'personalization-and-segmentation': 'Personalização e segmentação',
	...
	'please-check-this-box-if-the-file-you-upload-does-not-contain-any-personal-data-and-therefore-can-be-uploaded-to-and-accessed-from-any-liferay-support-location-globally':
		'Marque esta caixa se o arquivo que você está enviando não contiver dados pessoais e, portanto, puder ser carregado e acessado de qualquer local de suporte da Liferay no mundo.',
	'please-insert-a-valid-date': 'Por favor, insira uma data válida.',
	'please-let-us-know-if-you-have-any-feedback-on-the-support-you-received-during-this-time':
		'Por favor, informe-nos se você tem algum feedback sobre o suporte recebido durante este período.',
	'please-let-us-know-the-reason-you-are-canceling-this-event':
		'Por favor, informe-nos o motivo pelo qual você está cancelando este evento.',
	...
	'search-for-support-tickets': 'Pesquisar Tickets de Suporte',
	...
	'usage-data-not-loaded': 'Dados de Uso Não Carregados',
	'user': 'Usuário',
	'vr': 'RV',
